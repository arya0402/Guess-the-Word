...
function send() {
    ...
    remove_char_1 = word.replace(charAt1, "_");
    remove_char_2 = remove_char_1.replace(charAt2, "_");
    remove_char_3 = remove_char_2.replace(charAt3, "_");
    console.log(remove_char_3);

    question_word = "<h4 id = 'word_display'>Q. " + remove_char_3 + "</h4>";
...
function check() {
    ...
    if(question_turn == "Player1") {
        ...
        question_turn = "Player1";
        document.getElementById("question_turn").innerHTML = "Question Yurn - " + player1_name;
    }
